...
VALUES ("Corte de Cabello de Adulto", 80);
--
-- option#2 con 'comillas sencillas':
INSERT INTO servicios (nombre, precio)
VALUES ('Corte de Cabello Niño', 90);
--
...
LIMIT 2;
--
SELECT * FROM servicios ORDER BY id DESC LIMIT 2;
--
/* -------------- WHERE ------------- */
SELECT *
FROM servicios
...
--
UPDATE servicios SET nombre = "Corte de Cabello Adulto Actualizado", precio = 90 WHERE id = 1;
--
/* ---------------------------------- */
/*               DELETE               */
/* ---------------------------------- */
...
INSERT INTO servicios (nombre, precio)
VALUES ("Corte de Cabello Adulto", 90);
--
/* ---------------------------------- */
...
--
/* ------------- CHANGE ------------- */
ALTER TABLE servicios CHANGE descripcion nuevonombre VARCHAR(150) NOT NULL;
--
ALTER TABLE servicios CHANGE descripcion descripcion VARCHAR(150) NOT NULL;
--
INSERT INTO servicios (nombre, precio, descripcion) VALUES ('Peinado', 100, 'Hola');
--
/* ----------- DROP COLUMN ---------- */
